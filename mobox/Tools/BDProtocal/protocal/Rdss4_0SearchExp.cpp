...
static SInfoTitle RDSS4_0Title[] =
{
	...
	{CUNPACK_ZDA,"$SJXX"}, //UTC时间，日期，和本地时区等信息	GJ 2016.3.29
};
...
BOOL CRdss4_0SearchExp::IsValidTitles(char* strTitle)
{
...
void CRdss4_0SearchExp::SetRdssTitles()
{
	...
	m_vRdssTitle.push_back("$SJXX");//回执信息 GJ 2016.3.39
...
int  CRdss4_0SearchExp::EncodeFrame_rmo(lpRMOInfo pRmoInfo ,unsigned char frame[],int& len)
{
	...
	if(memcmp(pRmoInfo->chName,"ZDA",3) == 0){//时间输出
		...
		memcpy(frame+len,"$SJSC",sizeof("$SJSC"));
		len+=5;
		len+=2;
		__writeint_3bytes(frame,len,m_uLocalID);
		__writeint_2bytes(frame,len,pRmoInfo->nOutFreq);
...
int  CRdss4_0SearchExp::EncodeFrame(const void * pMsg,const UINT uMsgId,const int nMsgBlockLen, BYTE byFrameBuff[],const int nFrameBuffLen)
{
	...
	case DEVICE_BDCXA:
		{
			return encode_cxa(pMsg,uMsgId,nMsgBlockLen,byFrameBuff,nFrameBuffLen);		
		}
		break;
	case DEVICE_BDZHS:
		{
			return encode_zhs(pMsg,uMsgId,nMsgBlockLen,byFrameBuff,nFrameBuffLen);
		}
		break;
	case DEVICE_BDJMS:
		{		
			return encode_jms(pMsg,uMsgId,nMsgBlockLen,byFrameBuff,nFrameBuffLen);
		}
		break;
	case DEVICE_BDGXM:
		{
			return encode_gxm(pMsg,uMsgId,nMsgBlockLen,byFrameBuff,nFrameBuffLen);
		}
		break;
	case DEVICE_BDRMO:
		{			
			return encode_rmo(pMsg,uMsgId,nMsgBlockLen,byFrameBuff,nFrameBuffLen);
		}
		break;
	case DEVICE_BDICA:
		{
			return encode_ica(pMsg,uMsgId,nMsgBlockLen,byFrameBuff,nFrameBuffLen);
		}
		break;
	case DEVICE_BDTXA:
		{
			return encode_txa(pMsg,uMsgId,nMsgBlockLen,byFrameBuff,nFrameBuffLen);
		}
		break;
	case DEVICE_BDWAA:
		{			
			return encode_waa(pMsg,uMsgId,nMsgBlockLen,byFrameBuff,nFrameBuffLen);
		}
		break;

	case DEVICE_BDDWA:
		{
			return encode_dwa(pMsg,uMsgId,nMsgBlockLen,byFrameBuff,nFrameBuffLen);
		}
		break;
	case DEVICE_GLJC:
		{
			return encode_gljc(pMsg,uMsgId,nMsgBlockLen,byFrameBuff,nFrameBuffLen);
		}
		break;
	case DEVICE_XTZJ:
		{
			return encode_xtzj(pMsg,uMsgId,nMsgBlockLen,byFrameBuff,nFrameBuffLen);
		}
		break;
	case DEVICE_BDLZM:
		{
			return encode_lzm(pMsg,uMsgId,nMsgBlockLen,byFrameBuff,nFrameBuffLen);
		}
		break;
	}
}
...
static BOOL DecodeWAAInfo(BYTE byFrame[],int nFrameLen,lpWAAInfo pWAAInfo)
{
	...
	if(nSign)
	{
		UINT uData = GetUintFromBuff(dwArray, i ,14);
		pWAAInfo->dfHgt = ((int)uData)*-1 ;//14
	}
	else
	{
...
int CRdss4_0SearchExp::explain_hzr(BYTE byFrame[] , int nFrameLen,BYTE *DataBuff, DWORD &Len)
{
	int sender;
	...
	return CUNPACK_HZR;  //GJ 2016.3.29
}
int CRdss4_0SearchExp::explain_zhr(BYTE byFrame[] , int nFrameLen,BYTE *DataBuff, DWORD &Len)
{
...
int CRdss4_0SearchExp::explain_sbx(BYTE byFrame[] , int nFrameLen,BYTE *DataBuff, DWORD &Len)
{
	BOOL bExplain = FALSE;
	BYTE byRtn = CUNPACK_NULL;
...
int CRdss4_0SearchExp::explain_gxm(BYTE byFrame[] , int nFrameLen,BYTE *DataBuff, DWORD &Len)
{
	BOOL bExplain = FALSE;
	BYTE byRtn = CUNPACK_NULL;
...
int CRdss4_0SearchExp::explain_lzm(BYTE byFrame[] , int nFrameLen,BYTE *DataBuff, DWORD &Len)
{
	BOOL bExplain = FALSE;
	BYTE byRtn = CUNPACK_NULL;
...
int CRdss4_0SearchExp::explain_zda(BYTE byFrame[] , int nFrameLen,BYTE *DataBuff, DWORD &Len)
{
	BOOL bExplain = FALSE;
	BYTE byRtn = CUNPACK_NULL;
...
int CRdss4_0SearchExp::explain_gga(BYTE byFrame[] , int nFrameLen,BYTE *DataBuff, DWORD &Len)
{
	BOOL bExplain = FALSE;
	BYTE byRtn = CUNPACK_NULL;
...
int CRdss4_0SearchExp::explain_ici(BYTE byFrame[] , int nFrameLen,BYTE *DataBuff, DWORD &Len)
{
	BOOL bExplain = FALSE;
	BYTE byRtn = CUNPACK_NULL;
...
int CRdss4_0SearchExp::explain_txr(BYTE byFrame[] , int nFrameLen,BYTE *DataBuff, DWORD &Len)
{
	BOOL bExplain = FALSE;
	BYTE byRtn = CUNPACK_NULL;
...
int CRdss4_0SearchExp::explain_dwr(BYTE byFrame[] , int nFrameLen,BYTE *DataBuff, DWORD &Len)
{
	BOOL bExplain = FALSE;
	BYTE byRtn = CUNPACK_NULL;
...
int CRdss4_0SearchExp::explain_fki(BYTE byFrame[] , int nFrameLen,BYTE *DataBuff, DWORD &Len)
{
	BOOL bExplain = FALSE;
	BYTE byRtn = CUNPACK_NULL;
...
int CRdss4_0SearchExp::explain_bsi(BYTE byFrame[] , int nFrameLen,BYTE *DataBuff, DWORD &Len)
{
	BOOL bExplain = FALSE;
	BYTE byRtn = CUNPACK_NULL;
...
int CRdss4_0SearchExp::explain_zti(BYTE byFrame[] , int nFrameLen,BYTE *DataBuff, DWORD &Len)
{
	BOOL bExplain = FALSE;
	BYTE byRtn = CUNPACK_NULL;
...
int CRdss4_0SearchExp::encode_cxa(const void * pMsg,const UINT uMsgId,const int nMsgBlockLen, BYTE byFrameBuff[],const int nFrameBuffLen)
{
...
int  CRdss4_0SearchExp::encode_zhs(const void * pMsg,const UINT uMsgId,const int nMsgBlockLen, BYTE byFrameBuff[],const int nFrameBuffLen)
{
	int iter = 0;
...
int CRdss4_0SearchExp::encode_jms(const void * pMsg,const UINT uMsgId,const int nMsgBlockLen, BYTE byFrameBuff[],const int nFrameBuffLen)
{
...
int CRdss4_0SearchExp::encode_gxm(const void * pMsg,const UINT uMsgId,const int nMsgBlockLen, BYTE byFrameBuff[],const int nFrameBuffLen)
{
	int iter = 0;
	int nBufferLen=0;
...
int CRdss4_0SearchExp::encode_rmo(const void * pMsg,const UINT uMsgId,const int nMsgBlockLen, BYTE byFrameBuff[],const int nFrameBuffLen)
{
	int nBufferLen=0;
	int iter = 0;
...
int CRdss4_0SearchExp::encode_ica(const void * pMsg,const UINT uMsgId,const int nMsgBlockLen, BYTE byFrameBuff[],const int nFrameBuffLen)
{
	int iter = 0;
...
int CRdss4_0SearchExp::encode_txa(const void * pMsg,const UINT uMsgId,const int nMsgBlockLen, BYTE byFrameBuff[],const int nFrameBuffLen)
{
	int iter = 0;
	int nFrameLen=18;
...
int CRdss4_0SearchExp::encode_waa(const void * pMsg,const UINT uMsgId,const int nMsgBlockLen, BYTE byFrameBuff[],const int nFrameBuffLen)
{
	int iter = 0;
...
int CRdss4_0SearchExp::encode_dwa(const void * pMsg,const UINT uMsgId,const int nMsgBlockLen, BYTE byFrameBuff[],const int nFrameBuffLen)
{
	int iter = 0;
...
int CRdss4_0SearchExp::encode_gljc(const void * pMsg,const UINT uMsgId,const int nMsgBlockLen, BYTE byFrameBuff[],const int nFrameBuffLen)
{
	int iter = 0;
	const int nFramelen = 12;
...
int CRdss4_0SearchExp::encode_xtzj(const void * pMsg,const UINT uMsgId,const int nMsgBlockLen, BYTE byFrameBuff[],const int nFrameBuffLen)
{
	int iter = 0;
	const int nFramelen = 13;
...
int CRdss4_0SearchExp::encode_lzm(const void * pMsg,const UINT uMsgId,const int nMsgBlockLen, BYTE byFrameBuff[],const int nFrameBuffLen)
{

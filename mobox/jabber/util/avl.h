...
typedef struct libavl_allocator libavl_allocator_st, *libavl_allocator_t;
typedef struct avl_table avl_table_st, *avl_table_t;
typedef struct avl_node avl_node_st, *avl_node_t;
typedef struct avl_traverser avl_traverser_st, *avl_traverser_t;
...
struct avl_table *avl_create (avl_comparison_func *, void *,
                              struct libavl_allocator *, mempool_t);
...
void avl_clear (struct avl_table *, avl_item_func *);

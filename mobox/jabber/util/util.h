...
JABBERD2_API int64_t j_atoi64(const char *a);/* checks for NULL and uses default instead, convienence */
...
JABBERD2_API char* j_str_gbk2utf8(char *src, int srcl, char *dst, int dstl);
...
JABBERD2_API char			  *config_set_one(config_t c, const char *key, const char *value , int num, char* file, int savenow);
JABBERD2_API char			  *config_set_attr(config_t c, int elem, const char* attr,const char *value, int num, char* file);

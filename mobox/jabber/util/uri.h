...
#define uri_NOTIFY_AGLARM  "jabber:message:notify:alarm"
#define uri_NOTIFY_GEDODE  "jabber:message:notify:decode"
#define uri_MEASURE     "jabber:message:notify:measure"
#define uri_NOTIFY_IQTS "jabber:message:notify:IQts"
#define uri_NOTIFY_FILE "jabber:message:notify:measure:file"
#define uri_QUERY_FILE  "jabber:iq:measure:file"
#define uri_QUERY       "jabber:message:query:IQts"
#define uri_UPLOAD      "jabber:message:notify:send"
#define uri_QUERY_TASK  "jabber:iq:task"
#define uri_QUERY_BCC   "jabber:iq:bcc"       
#define uri_NOTIFY_TASK "jabber:message:notify:task"
...
#define uri_COMMAND     "jabber:iq:command"
